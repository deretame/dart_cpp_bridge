...
slug: v1/guides/fundamentals/lifecycle
---
...
* [Function Marker Selection Guide](/dart_cpp_bridge/v1/guides/fundamentals/markers/)
* [Architecture Design](/dart_cpp_bridge/v1/guides/fundamentals/architecture/)
