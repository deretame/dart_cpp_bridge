...
See [Basic Runtime](/dart_cpp_bridge/v1/guides/fundamentals/runtime/) and [async-simple Coroutines Primer](/dart_cpp_bridge/v1/guides/fundamentals/async-simple/) for details.
...
* [Quick Start](/dart_cpp_bridge/v1/getting-started/) — create a project, install tools, generate your first bindings
* [Architecture Design](/dart_cpp_bridge/v1/guides/fundamentals/architecture/) — core components and call flow
* [Marker Selection Guide](/dart_cpp_bridge/v1/guides/fundamentals/markers/) — choose `BRIDGE_SYNC` / `ASYNC` / `NORMAL` / `Stream` / `DartFn`
* [Streams](/dart_cpp_bridge/v1/guides/fundamentals/streams/) — required and optional streams with `StreamSink`
* [Lifecycle Management](/dart_cpp_bridge/v1/guides/fundamentals/lifecycle/) — Runtime, Session, Opaque objects, NativeFinalizer
* [Exceptions and Error Handling](/dart_cpp_bridge/v1/guides/fundamentals/errors/) — C++ ↔ Dart exception propagation rules
* [Project Directory Structure](/dart_cpp_bridge/v1/guides/fundamentals/project-structure/) — hand-written files and generated artifacts
...
* [C++ ↔ Dart Type Encoding](/dart_cpp_bridge/v1/guides/fundamentals/encoding/) — how C++ types map to Dart types
* [Basic Runtime](/dart_cpp_bridge/v1/guides/fundamentals/runtime/) — Runtime, spawn, channel, sleep
* [async-simple Coroutines Primer](/dart_cpp_bridge/v1/guides/fundamentals/async-simple/) — `Lazy`, `Executor`, `co_await` behavior
* [Type Mapping](/dart_cpp_bridge/v1/codegen/type-mapping/) — C++ ↔ Dart types and constraints
