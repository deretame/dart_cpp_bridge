...
description: The built-in asio + async-simple runtime in dart_cpp_bridge, plus
  foundational tools such as spawn, spawn_blocking, channel, and sleep.
slug: v1/guides/fundamentals/runtime
---
...
* [async-simple Coroutine Basics](/dart_cpp_bridge/v1/guides/fundamentals/async-simple/)
* [Architecture](/dart_cpp_bridge/v1/guides/fundamentals/architecture/)
* [Multi-Runtime](/dart_cpp_bridge/v1/guides/advanced/multi-runtime/)
* [Foreign Runtime Integration](/dart_cpp_bridge/v1/guides/advanced/foreign-runtime/)
* [Pure C Bridge API](/dart_cpp_bridge/v1/guides/advanced/cbridge/)
