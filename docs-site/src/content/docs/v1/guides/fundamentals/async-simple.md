...
description: "Basic usage of the async-simple coroutine library used by
  dart_cpp_bridge: Lazy, Executor, co_await, starting coroutines, and the
  threading model"
slug: v1/guides/fundamentals/async-simple
---
...
## Does the Executor propagate along the co\_await chain?
...
### Relationship with spawn\_blocking
...
[Foreign Runtime Integration](/dart_cpp_bridge/v1/guides/advanced/foreign-runtime/).
...
This bug is unrelated to the executor; any coroutine lambda on any executor can trigger it. See [MSVC Notes](/dart_cpp_bridge/v1/guides/advanced/foreign-runtime/#msvc-notes) for details.
...
* [Foreign Runtime Integration](/dart_cpp_bridge/v1/guides/advanced/foreign-runtime/) — ForeignExecutor, MSVC notes
