...
description: How C++ exceptions propagate to Dart and how Dart closure
  exceptions return to C++
slug: v1/guides/fundamentals/errors
---
...
* [Marker Selection Guide](/dart_cpp_bridge/v1/guides/fundamentals/markers/)
