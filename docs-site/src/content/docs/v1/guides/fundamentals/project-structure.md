...
slug: v1/guides/fundamentals/project-structure
---
...
* `native/api/*.h` and everything they include transitively are parsed by
  ...
  [Header Organization](/dart_cpp_bridge/v1/codegen/configuration/#header-organization-recommendations).
...
* [Code Generation Configuration](/dart_cpp_bridge/v1/codegen/configuration/)
* [Code Generation Output](/dart_cpp_bridge/v1/codegen/output/)
