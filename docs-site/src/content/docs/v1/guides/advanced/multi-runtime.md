...
description: Create independent asio + async-simple runtimes outside the
  dart_cpp_bridge main Runtime, and communicate with the main Runtime through
  coroutine channels.
slug: v1/guides/advanced/multi-runtime
---
...
* [Fundamentals: Runtime](/dart_cpp_bridge/v1/guides/fundamentals/runtime/) — `spawn`, `spawn_blocking`, channel, sleep
* [async-simple Coroutine Basics](/dart_cpp_bridge/v1/guides/fundamentals/async-simple/) — `Lazy`, `Executor`, `co_await` behavior
* [Foreign Runtime Integration](/dart_cpp_bridge/v1/guides/advanced/foreign-runtime/) — integrating non-asio event loops (libuv, glib) with the bridge
