...
// NativeFinalizer callback: [token] is the session id encoded as a pointer
// value (not a heap allocation). Safe if session already closed.
...
// Drop an object handle created by a constructor method.
