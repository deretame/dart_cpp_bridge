...
//   auto v = co_await std::move(rx);               // optional<int> (in stdexec::task)
...
//   auto v = co_await rx.recv();                      // optional<T> (in stdexec::task)
